...
## Проект основан на знаниях, полученных в процессе изучения JavaScript. Мы работали с DOM-элементами, массивами и научились создавать модальные окна на JavaScript. Также мы организовали валидацию форм на сайте, включая возможность создания собственной проверки.
Кроме того, мы применяли свои навыки в работе с API: получали данные от сервера, а также могли удалять и редактировать их.
